...
LogoButton.Position = UDim2.new(0, 16, 0.5, -27)
...
MainFrame.Size = UDim2.new(0, 285, 0, 380)
MainFrame.Position = UDim2.new(0.5, -142, 0.5, -190)
...
Tabs.Position = UDim2.new(0, 12, 0, 75)
Tabs.BackgroundTransparency = 1
Tabs.Parent = MainFrame

local SpeedFlyTab = Instance.new("TextButton")
SpeedFlyTab.Size = UDim2.new(0.5, -5, 1, 0)
...
SpeedFlyCorner.CornerRadius = UDim.new(0, 9)
SpeedFlyCorner.Parent = SpeedFlyTab

local NoClipTab = Instance.new("TextButton")
NoClipTab.Size = UDim2.new(0.5, -5, 1, 0)
NoClipTab.Position = UDim2.new(0.5, 5, 0, 0)
...
Content.Position = UDim2.new(0, 12, 0, 125)
...
Layout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
    Content.CanvasSize = UDim2.new(0, 0, 0, Layout.AbsoluteContentSize.Y + 25)
end)
...
local function CreateSlider(parent, name, minValue, maxValue, defaultValue, callback)
    ...
    Track.Size = UDim2.new(1, -4, 0, 9)
    Track.Position = UDim2.new(0, 2, 0, 34)
...
SpeedFlyLayout.Padding = UDim.new(0, 9)
...
NoClipLayout.Padding = UDim.new(0, 9)
...
NoClipInfo.Size = UDim2.new(1, -4, 0, 44)
...
FlyControls.Size = UDim2.new(0, 68, 0, 112)
FlyControls.Position = UDim2.new(1, -86, 1, -145)
...
local function CreateFlyButton(text, y)
    local Button = Instance.new("TextButton")
    Button.Size = UDim2.new(0, 58, 0, 48)
    Button.Position = UDim2.new(0, 0, 0, y)
    Button.BackgroundColor3 = Color3.fromRGB(23, 19, 30)
    Button.Text = text
...
local UpButton = CreateFlyButton("▲", 0)
local DownButton = CreateFlyButton("▼", 58)
...
UserInputService.InputChanged:Connect(function(input)
    if not draggingLogo then return end
